...
namespace Vuefront\Blog\Block\Adminhtml\Category;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Vuefornt_Blog::category_save')) {
        ...
        if ($this->_isAllowedAction('Vuefront_Blog::category_delete')) {
